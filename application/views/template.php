  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo base_url('dashboard/d_matkul');?>">
          <i class="fa fa-plus-square"></i>Daftar Matkul
          </a>
        </li>
        <li>
          <a href="<?php echo base_url('dashboard/d_dosen');?>">
          <i class="fa fa-plus-square"></i>Daftar Dosen
          </a>
        </li>
        <li>
          <a href="<?php echo base_url('dashboard/d_mahasiswa');?>">
          <i class="fa fa-plus-square"></i>Daftar Mahasiswa
          </a>
        </li>
        <li>
          <a href="<?php echo base_url('dashboard/d_jadwal');?>">
